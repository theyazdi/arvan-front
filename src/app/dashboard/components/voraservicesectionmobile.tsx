...
function VoraServicesectionMobile() {
  return (
    <Dialog>
      ...
      <DialogContent className="p-8">
        <DialogTitle className="flex flex-col gap-3 items-start">
          ...
          <div className="flex flex-col gap-3 w-full">
            ...
            <div className="flex items-center gap-6 bg-[#FAFAFA] p-2 rounded-xl">
              <div className="flex flex-col gap-2 items-start">
                <h3 className="text-sm font-bold">برنامه ریزی سفر</h3>
                <p className="text-sm text-[#757575] font-400">
                  لورم ایپسوم، متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.
                </p>
              </div>
            ...
            <div className="flex items-center gap-6 bg-[#FAFAFA] p-2 rounded-xl">
              <div className="flex flex-col gap-2 items-start">
                <h3 className="text-sm font-bold">مسافرت با بودجه مشخص</h3>
                <p className="text-sm text-[#757575] font-400">
                  لورم ایپسوم، متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ.
                </p>
              </div>
...
export { VoraServicesectionMobile };
